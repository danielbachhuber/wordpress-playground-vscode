...
if ( ! file_exists( WP_CONTENT_DIR . '/plugins/sqlite-database-integration/wp-includes/sqlite/db.php' ) ) {
	return;
}
...
require_once WP_CONTENT_DIR . '/plugins/sqlite-database-integration/wp-includes/sqlite/db.php';
